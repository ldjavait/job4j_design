...
class SimpleCollectionTest {
    /**
     * Тестовый метод показывает основные операции проверки содержания коллекции.
     */
    @Test
    void generalAssert() {
    ...
    /**
     * Тестовый метод показывает, как можно проверить выполнение элементами коллекции нужных условий.
     */
    @Test
    void satisfyAssert() {
        SimpleCollection<Integer> simpleCollection = new SimpleCollection<>(1, 1, 3, 4, 5);
    ...
    /**
     * Тестовый метод показывает, что можно выбрать один элемент из коллекции и дальше проверять только его.
     */
    @Test
    ...
    /**
     * Тестовый метод показывает, как можно выбрать из коллекции группу элементов по некоторому условию
     * и дальше работать с отобранной.
